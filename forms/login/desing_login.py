...
class DesingLogin:
	...
	def __init__(self):
		...
		self.aplicacion.title('Log In')
		# self.aplicacion.overrideredirect(True)
		# logo de la ventana
		self.aplicacion.iconbitmap('Img/DntLogo.ico')
		# Tamaño y posicion de la ventana
		utl.centrar_ventana(self.aplicacion,400,600)
		...
		# frame_logo
		frame_logo = tk.Frame(self.aplicacion, bd=0, height=150, relief=tk.SOLID, padx=10, pady=10,bg='#3a7ff6')
		...
		# frame_form
		frame_form = tk.Frame(self.aplicacion, bd=0, relief=tk.SOLID, bg='#fff')
		...
		inicio = tk.Button(frame_form_fill,text="Iniciar sesion",font=('Times', 15),bg='#3a7ff6', bd=0,fg="#fff",cursor='hand2',command=self.ingresar)
		inicio.pack(fill=tk.X, padx=10,pady=10)
		registro = tk.Button(frame_form_fill,text="Registrar",font=('Times', 15),bg='#fff', bd=0,fg="#3a7ff6",cursor='hand2',command=self.userRegister)
		...
		salir = tk.Button(frame_salir,text="Salir",font=('Times', 15),bg='#fff', bd=0,fg="grey",cursor='hand2',command=self.aplicacion.destroy)
