...
class DesingRegister():
	...
	def __init__(self):
		...
		title = tk.Label(frame_form_top, text="Registro de usuario", font=(
			'Times', 30), fg="#000", bg='#fcfcfc', pady=30)
		...
		inicio = tk.Button(frame_form_fill, text="Registrar", font=('Times', 15), bg='#3a7ff6', bd=0, fg="#fff", command=self.registrar)
		...
		salir = tk.Button(frame_salir,text="Calcelar",font=('Times', 15),bg='#fff', bd=0,fg="grey",command=self.ventana.destroy)
